...
ROLES = (
    ...
    "RUN17_TRUNK_FORWARDING_ORDER_CAUSAL_INTERVENTION",
    "RUN18_VOICE_BOOTSTRAP_ORDER_CAUSAL_INTERVENTION",
    "RUN19_ACCESS_PREPARATION_CAUSAL_INTERVENTION",
    "RUN20_PRODUCTION_FOUNDATION_GATED_VERIFICATION",
    "RUN21_PRODUCTION_CROSS_STAGE_VERIFICATION",
    "RUN22_PRODUCTION_NO_ARM_VERIFICATION",
    "RUN23_PRODUCTION_COMPLETE_CONVERGENCE_VERIFICATION",
)
