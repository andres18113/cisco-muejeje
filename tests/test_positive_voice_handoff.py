...
def test_current_cp_scale_voice_state_uses_exact_values():
    ...
    expected = {
        ...
        "CANONICAL_CP_SCALE_PRELIVE_HEAD": (
            "6c6db55566890f1d9ca9cc06bfc13ae24505e793"
        ),
        ...
        "CANONICAL_CP_SCALE_STAGE_VOICE_COUNTS": (
            "FLOOR1_21 | FLOOR2_35 | FLOOR3_42 | ROUTER0_62 | ROUTER3_69"
        ),
        "CANONICAL_CP_SCALE_PRODUCTION_PATH": (
            "CONFIRMED_OFFLINE_ALL_STAGES_AND_LIVE_THROUGH_FLOOR3_VOICE"
        ),
        ...
        "CANONICAL_CP_SCALE_CURRENT_BOUNDARY": (
        ...
        "CANONICAL_CP_SCALE_PHONE_ACCESS_FWD": (
            "EXPECTED_69 | VERIFIED_42 | FAILED_0 | UNOBSERVABLE_0 | "
            "NOT_REACHED_27"
        ),
        "CANONICAL_CP_SCALE_REGISTRATION_AFTER_FWD_BARRIER": (
            "YES_FLOOR1_FLOOR2_FLOOR3 | NOT_ESTABLISHED_LATER_STAGES"
        ),
        "CANONICAL_CP_SCALE_NOT_REACHED_PHONES": "27",
        "CANONICAL_CP_SCALE_FIRST_CONTRADICTED_BOUNDARY": (
            "FLOOR3_VOICE_SIGNAL_SWITCH9_VLAN20_PVST_LRN_AFTER_"
            "SINGLE_EXTENSION"
        ),
        ...
        "CANONICAL_CP_SCALE_FLOOR2_VOICE_MUTATION_PREVIOUS": (
            "DELTA_29_RETAINED_46_REACHED_NEW_BINDING"
        ),
        "CANONICAL_CP_SCALE_FLOOR2_VOICE_FIRST_FAILURE": (
            "NEW_FLOOR2_BINDING_22_PAGER_UNOBSERVABLE_2_OF_2"
        ),
        "CANONICAL_CP_SCALE_FLOOR2_VOICE_DELTA": (
            "VERIFIED_REPLAY_REFUTED_AS_SUFFICIENT"
        ),
        "CANONICAL_CP_SCALE_FLOOR2_GROUPED_BINDING_FRONTIER": (
            "VERIFIED_14_OF_14 | ONE_8_PAGE_AUTHORITATIVE_TABLE | "
            "NO_RECONCILIATION"
        ),
        "CANONICAL_CP_SCALE_PAGER_COMBINED_ROLLOVER": (
            "CONFIRMED"
        ),
        "CANONICAL_CP_SCALE_PAGER_WINDOW_CORRECTION": (
            "VERIFIED_PRODUCTION"
        ),
        "CANONICAL_CP_SCALE_PAGER_WINDOW_SAFETY": (
            "FULL_CSI_PYTHON_JS_PARITY | ACTIVE_WITH_SYSLOG_TAIL | "
            "SYSLOG_ONLY_NOT_PROGRESS | NONEMPTY_SESSION_BASE"
        ),
        "CANONICAL_CP_SCALE_CONTROL_PLANE_DELTA": (
            "ROUTING_CORE_3 | ROUTER4_SWITCH10_0 | FLOOR1_0 | FLOOR2_0 | "
            "FLOOR3_157 | ROUTER0_40 | ROUTER3_17 | FULL_0"
        ),
        ...
        "CANONICAL_CP_SCALE_PAGER_TRANSCRIPT_CONTINUITY_HEAD": (
            "3b4da405711ee6859da3f46b737a2003fbf92fb2"
        ),
        ...
        "CANONICAL_CP_SCALE_FLOOR3_VOICE": (
            "PRIOR_VERIFIED_42_OF_42 | "
            "LATEST_ATTEMPT_BLOCKED_AT_SIGNAL_SWITCH9_3_LRN"
        ),
        "CANONICAL_CP_SCALE_FLOOR3_VOICE_MUTATION": (
            "DELTA_15 | RETAINED_74"
        ),
        "CANONICAL_CP_SCALE_ROUTER0_VOICE_MUTATION": (
            "DELTA_45 | RETAINED_89"
        ),
        "CANONICAL_CP_SCALE_FLOOR3_ROUTER4_CAPACITY": (
            "MAX_EPHONES_42 | MAX_DN_42"
        ),
        "CANONICAL_CP_SCALE_FLOOR3_PRE_REBALANCE_NEW_BINDINGS": (
            "36_TO_51_ALL_AUTHORITATIVELY_ABSENT"
        ),
        "CANONICAL_CP_SCALE_FLOOR3_PRE_REBALANCE_RECONCILIATION": (
            "ATTEMPTED_16_ACCEPTED_16_FINAL_TABLE_STILL_1_TO_35"
        ),
        "CANONICAL_CP_SCALE_ROUTER4_CAPACITY_MISMATCH": (
            "CONFIRMED_51_PHONES_GT_42"
        ),
        "CANONICAL_CP_SCALE_FLOOR3_CONTROL_PLANE": (
            "PARTIAL_STP_CAPABILITY_UNKNOWN"
        ),
        "CANONICAL_CP_SCALE_FLOOR3_STP_CAPABILITY": (
            "3560-24PS_UNKNOWN_156 | 2960-24TT_UNKNOWN_1"
        ),
        "CANONICAL_CP_SCALE_FLOOR3_RETAINED_RIP_OBSERVATIONS": (
            "VERIFIED_12_OF_12"
        ),
        "STP_PVST_QUALIFICATION_RUN1_HEAD": (
            "7aead990dcccb104e35278223507df9ec1a63211"
        ),
        "STP_PVST_QUALIFICATION_RUN1_RESULT": (
            "HARNESS_IDENTITY_AMBIGUOUS_AFTER_TRUNK_FWD"
        ),
        "STP_PVST_QUALIFICATION_RUN1_TRUNK": (
            "3560_CONFIRMED_FWD | 2960_FWD_IDENTITY_AMBIGUOUS"
        ),
        "STP_PVST_QUALIFICATION_RUN1_STP_MUTATION": "NOT_DISPATCHED",
        "STP_PVST_QUALIFICATION_RUN1_ROOT_CAUSE": (
            "DUPLICATE_DEFAULT_SWITCH_PROMPTS"
        ),
        "STP_PVST_QUALIFICATION_RUN1_CORRECTION": "UNIQUE_TYPED_HOSTNAMES",
        "STP_PVST_QUALIFICATION_RUN1_SHA256": (
            "5da968302f54bd03e5c8a961182d10dd74d40fa251356b07dcc5b3ddb2f44a51"
        ),
        "STP_PVST_QUALIFICATION_RUN1_CLEANUP": (
            "ZERO_SEMANTIC_DEVICES_LINKS_TWICE | REALTIME_VERIFIED"
        ),
        "STP_PVST_QUALIFICATION_RUN2_HEAD": (
            "71fae1c74878eee2d9fd8ac9330c11c781e0f155"
        ),
        "STP_PVST_QUALIFICATION_RUN2_RESULT": (
            "PVST_CONFIG_AND_STATE_VERIFIED_EXACT_MODELS"
        ),
        "STP_PVST_QUALIFICATION_RUN2_MUTATIONS": (
            "3560_PRIMARY_PLUS_EDGE_APPLIED | 2960_SECONDARY_APPLIED"
        ),
        "STP_PVST_QUALIFICATION_RUN2_STATE": (
            "3560_ROOT_PRIMARY_VERIFIED | 2960_ROOT_SECONDARY_VERIFIED"
        ),
        "STP_PVST_QUALIFICATION_RUN2_BEHAVIOR": "NOT_YET_QUALIFIED",
        "STP_PVST_QUALIFICATION_RUN2_SHA256": (
            "b7096988c199092e3ff187a0b047e6fb5e285e9607aa9999f8d57c47366df5ee"
        ),
        "STP_PVST_QUALIFICATION_RUN2_CLEANUP": (
            "ZERO_SEMANTIC_DEVICES_LINKS_TWICE | REALTIME_VERIFIED"
        ),
        "STP_PVST_QUALIFICATION_RUN3_HEAD": (
            "29afd03bdd215d16b5d2e7c9eef5ea53e4a521c1"
        ),
        "STP_PVST_QUALIFICATION_RUN3_RESULT": (
            "CONFIG_STATE_BEHAVIOR_VERIFIED_FLOOR3_MODELS"
        ),
        "STP_PVST_QUALIFICATION_RUN3_OBSERVATIONS": (
            "3560_STATE_BEHAVIOR_VERIFIED | 2960_STATE_BEHAVIOR_VERIFIED"
        ),
        "STP_PVST_QUALIFICATION_RUN3_SHA256": (
            "1de1d5d8b3b3da2dfa7264689daf42af52b8b6b3493111165b5345136a19165b"
        ),
        "STP_PVST_QUALIFICATION_RUN3_CLEANUP": (
            "ZERO_SEMANTIC_DEVICES_LINKS_TWICE | REALTIME_VERIFIED"
        ),
        "STP_PVST_ROUTER0_3650_REQUIREMENT": (
            "MUTATIONS_17 | STATE_EXPECTATIONS_3 | BEHAVIOR_EXPECTATIONS_3 | "
            "EXACT_MODEL_CAPABILITY_SUPPORTED"
        ),
        "STP_PVST_QUALIFICATION_RUN4_HEAD": (
            "c61ee6626d6536be49b986bbd2fae72c78c29cf2"
        ),
        "STP_PVST_QUALIFICATION_RUN4_RESULT": (
            "PRIMARY_BEHAVIOR_BOUNDARY_EXPIRED_AFTER_ALL_MUTATIONS_AND_STATE_"
            "VERIFIED"
        ),
        "STP_PVST_QUALIFICATION_RUN4_MUTATIONS": "FIVE_OF_FIVE_APPLIED",
        "STP_PVST_QUALIFICATION_RUN4_STATE": "THREE_OF_THREE_VERIFIED",
        "STP_PVST_QUALIFICATION_RUN4_BEHAVIOR": (
            "LEAVES_TWO_VERIFIED | PRIMARY_FAILED_4_ATTEMPTS"
        ),
        "STP_PVST_QUALIFICATION_RUN4_CLASSIFICATION": (
            "OBSERVER_CONVERGENCE_BOUNDARY"
        ),
        "STP_PVST_QUALIFICATION_RUN4_CORRECTION": (
            "TWO_IDENTICAL_STABLE_SAMPLES | 45S_MEASURED_BOUND | "
            "TRANSITION_RETENTION"
        ),
        "STP_PVST_QUALIFICATION_RUN4_SHA256": (
            "e1eac60ca0b304fa6b26a9fb233de4b9e540ab5f8371279a5b86d1db8ac5832c"
        ),
        "STP_PVST_QUALIFICATION_RUN4_CLEANUP": (
            "ZERO_SEMANTIC_DEVICES_LINKS_TWICE | REALTIME_VERIFIED"
        ),
        "STP_PVST_TYPE_SPLIT_HEAD": (
            "ed386bcd37f52854e0b966cb1a1da248337fbb00"
        ),
        "STP_PVST_TYPE_SAFETY": (
            "GLOBAL_STP_PVST_CONFIG_SEPARATE_FROM_EDGE_STP_EDGE_CONFIG"
        ),
        "STP_PVST_QUALIFICATION_RUN5_HEAD": (
            "ed386bcd37f52854e0b966cb1a1da248337fbb00"
        ),
        "STP_PVST_QUALIFICATION_RUN5_RESULT": (
            "CONFIG_EDGE_STATE_BEHAVIOR_VERIFIED_EXACT_THREE_MODELS"
        ),
        "STP_PVST_QUALIFICATION_RUN5_MUTATIONS": (
            "GLOBAL_3560_2960_3650_APPLIED | EDGE_3560_3650_APPLIED | "
            "EDGE_2960_NOT_EXERCISED"
        ),
        "STP_PVST_QUALIFICATION_RUN5_STATE": "THREE_OF_THREE_VERIFIED",
        "STP_PVST_QUALIFICATION_RUN5_BEHAVIOR": (
            "THREE_OF_THREE_VERIFIED_TWO_IDENTICAL_STABLE_SAMPLES"
        ),
        "STP_PVST_QUALIFICATION_RUN5_CAPABILITY": (
            "3560_PVST_EDGE_STATE_BEHAVIOR_SUPPORTED | "
            "2960_PVST_STATE_BEHAVIOR_SUPPORTED_EDGE_UNKNOWN | "
            "3650_PVST_EDGE_STATE_BEHAVIOR_SUPPORTED"
        ),
        "STP_PVST_CONFIG_STATUS_BY_MODEL": (
            "3560-24PS_SUPPORTED | 2960-24TT_SUPPORTED | "
            "3650-24PS_SUPPORTED"
        ),
        "STP_EDGE_CONFIG_STATUS_BY_MODEL": (
            "3560-24PS_SUPPORTED | 2960-24TT_UNKNOWN | "
            "3650-24PS_SUPPORTED"
        ),
        "STP_STATE_STATUS_BY_MODEL": (
            "3560-24PS_SUPPORTED | 2960-24TT_SUPPORTED | "
            "3650-24PS_SUPPORTED"
        ),
        "STP_BEHAVIOR_STATUS_BY_MODEL": (
            "3560-24PS_SUPPORTED | 2960-24TT_SUPPORTED | "
            "3650-24PS_SUPPORTED"
        ),
        "STP_PVST_QUALIFICATION_RUN5_SHA256": (
            "3e1b9e4fc2a4eab5e26622250eec4a724a3e5dd029406f510730d485a1550edd"
        ),
        "STP_PVST_QUALIFICATION_RUN5_CLEANUP": (
            "ZERO_SEMANTIC_DEVICES_LINKS_TWICE | REALTIME_VERIFIED | "
            "INDEPENDENT_ZERO_SEMANTIC_DEVICES_LINKS_TWICE_REALTIME_VERIFIED"
        ),
        "STP_PVST_UNMEASURED": (
            "RAPID_PVST_UNKNOWN | MST_UNKNOWN | FAILOVER_UNKNOWN | "
            "UNRELATED_DIMENSIONS_UNKNOWN"
        ),
        ...
        "CME_CAPACITY_MODEL_ISR4321": (
            "SUPPORTS_CME_UNKNOWN | VERIFY_FAILED_NO_EPHONE_ROW"
        ),
        "CME_CAPACITY_MODEL_ISR4331": (
            "SUPPORTS_CME_UNKNOWN | VERIFY_FAILED_NO_EPHONE_ROW"
        ),
        "CME_CAPACITY_ISR_PROBE_CLEANUP": (
            "VERIFIED_ZERO_SEMANTIC_DEVICES_AND_LINKS_TWICE"
        ),
        "CME_CAPACITY_ISR_PROBE_SHA256": (
        ...
        "CME_CAPACITY_CORRECTION": (
            "VERIFIED_FLOOR3_REBALANCE_9_PHONES_ROUTER4_TO_ROUTER0 | "
            "CAPACITIES_42_20_7 | PRESERVE_314_DEVICES_219_LINKS_69_PHONES"
        ),
        "CME_CAPACITY_CORRECTED_TOPOLOGY_REFERENCE_SHA256": (
            "D611579176F128497CB9D0DBB3EEC387A147D1C75A4182B1A1C9D4E2A4839D1F"
        ),
        "CME_CAPACITY_CORRECTED_LOGICAL_REFERENCE_SHA256": (
            "70EE0D4882D73CA1363FF6D9E5FF640CDFB234476BFFD4E68F35B51B10588409"
        ),
        ...
        "CANONICAL_CP_SCALE_RUN21_EVIDENCE_SHA256": (
            "PRECLEANUP_e5a8e0ddf05c905d468227a61adc17bf6c9f9c367a7ff15080aaf494011c6dc1"
            " | CLEANUP_57c428a9ad5afe4d5f9d39e02b83498d274241c25b54fdd6efd3ac322237babe"
        ),
