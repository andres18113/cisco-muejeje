...
def test_current_cp_scale_voice_state_uses_exact_values():
    ...
    expected = {
        ...
        "CP_SCALE_CANONICAL_LIVE_RUN": "EXECUTED_TWICE",
        "CANONICAL_CP_SCALE_LIVE_RUN": "EXECUTED_TWICE",
        "CANONICAL_CP_SCALE_LIVE_ATTEMPTS": "2",
        ...
        "CANONICAL_CP_SCALE_FLOOR1_VOICE": (
            "ENDPOINT_AND_BINDING_VERIFIED_21_OF_21 | SCCP_REGISTERED_19 | "
            "SCCP_UNOBSERVABLE_2"
        ),
        ...
        "CANONICAL_CP_SCALE_FLOOR1_ENDPOINTS": (
            ...
            "MATCHING_BINDINGS_21 | SCCP_REGISTERED_19 | "
            "SCCP_UNOBSERVABLE_2"
        ),
        "CANONICAL_CP_SCALE_FLOOR1_MISSING_EPHONE_EXTENSIONS": (
            "3001 | 3007"
        ),
        "CANONICAL_CP_SCALE_FLOOR1_RAW_REPORTED_BOUNDARY": (
            "ENDPOINT_ADDRESS_OBSERVER_MISLOCALIZATION"
        ),
        ...
        "LIVE_RUNS_CONSUMED": "8",
        "CLEANUP": "VERIFIED_AFTER_EVERY_LIVE",
        "WORKSPACE_RESTORED": "YES",
        "NEXT_ACTIVE_STEP": (
            "RUN_SCCP_DIAGNOSTIC_CANONICAL_LIVE_WITH_RAW_EPHONE_AND_MAC_BATCH_"
            "RETENTION"
        ),
        "CP_SCALE_STATUS": (
