...
def test_current_cp_scale_voice_state_uses_exact_values():
    ...
    expected = {
        ...
        "CANONICAL_CP_SCALE_PRELIVE_HEAD": (
            "7ea42ee7d5db1a633639b2280eec24f2f041493d"
        ),
        ...
        "CANONICAL_CP_SCALE_FLOOR2_GROUPED_BINDING_FRONTIER": (
            "DISPATCHED_14_NEW_ONCE | ONE_GROUPED_TABLE_2_ATTEMPTS | "
            "PAGE3_ROLLED_UNATTRIBUTABLE"
        ),
        "CANONICAL_CP_SCALE_PAGER_COMBINED_ROLLOVER": (
            "HEAD_ROLL_PLUS_MORE_TAIL_ERASURE_STRONGLY_SUPPORTED"
        ),
        "CANONICAL_CP_SCALE_PAGER_WINDOW_CORRECTION": (
            "REQUIRE_PRE_MARKER_512_BYTE_LINE_BEARING_SUFFIX | "
            "NO_GENERIC_FALLBACK"
        ),
        ...
        "NEXT_ACTIVE_STEP": (
            "RUN_CANONICAL_LIVE_WITH_PAGER_PRE_MARKER_SUFFIX_ANCHOR"
        ),
        "CP_SCALE_STATUS": (
