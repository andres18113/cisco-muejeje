...
def test_current_cp_scale_voice_state_uses_exact_values():
    ...
    expected = {
        ...
        "CANONICAL_CP_SCALE_FLOOR3_NEW_BINDINGS": (
            "36_TO_51_ALL_AUTHORITATIVELY_ABSENT"
        ),
        "CANONICAL_CP_SCALE_FLOOR3_RECONCILIATION": (
        ...
        "CME_CAPACITY_CORRECTION": (
            "REBALANCE_9_PHONES_ROUTER4_TO_ROUTER0 | "
            "PRESERVE_314_DEVICES_219_LINKS_69_PHONES"
        ),
        ...
        "NEXT_ACTIVE_STEP": (
            "IMPLEMENT_AND_VERIFY_EXISTING_2811_CME_PHONE_REBALANCE"
        ),
        "CP_SCALE_STATUS": (
