...
from .physical_deployment import (
    ...
    PhysicalLinkObservation, PhysicalModuleEffectCapability,
    PhysicalModuleObservation, PhysicalModuleSlotObservation, PhysicalMutationResult,
    PhysicalObjectKind, PhysicalWorkspaceDeviceObservation,
    PhysicalWorkspaceLinkObservation, PhysicalWorkspaceObservation,
...
from .control_plane import (
    ...
    ConfigureRipv2, ConfigureSpanningTree, ConfigureStpEdgePort,
    ...
    LinkFailureScenarioIntent, RipNetwork, StpIntent, StpMode,
)
...
from .wireless_connectivity import (
    BLOCKED_CAPABILITY_STATUSES, MEASURED_CAPABILITY_STATUSES,
    AccessPointCandidate, AccessPointOwnership, AccessPointSelection,
    AddressingSource, BackendErrorKind, BackendIdentity,
    IntendedNetworkSegment, IoTFunction,
    ...
    WirelessParticipation, WirelessSecurityMode, WirelessServiceSetIntent,
    ReadingProvenance,
    classify_association_state, classify_attachment_state,
    iot_function_for_role, reading_provenance, wireless_participation,
)
...
__all__ = [
    ...
    "ConfigureOspfv2", "ConfigureRipv2", "ConfigureSpanningTree",
    ...
    "PhysicalDeploymentStatus", "PhysicalDeviceObservation",
    "PhysicalLinkObservation", "PhysicalModuleEffectCapability",
    "PhysicalModuleObservation", "PhysicalModuleSlotObservation",
    "PhysicalMutationResult", "PhysicalObjectKind",
    "PhysicalWorkspaceDeviceObservation", "PhysicalWorkspaceLinkObservation",
    "PhysicalWorkspaceObservation", "physical_workspace_restoration_matches",
    "CapabilityReadiness", "EvidenceFreshness", "EvidenceRecord", "EvidenceStrength",
    "ObservationStatus", "ReadinessStatus", "SupportStatus", "VerificationMethod",
    "VerificationStatus", "evidence_from_legacy_result",
