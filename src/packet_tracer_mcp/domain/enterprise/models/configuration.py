...
class ConfigurationIssueCode(StrEnum):
    ...
    ENDPOINT_INTERFACE_MISSING = "ENDPOINT_INTERFACE_MISSING"
    ...
    EMAIL_ACCOUNT_MISSING = "EMAIL_ACCOUNT_MISSING"
    EMAIL_CLIENT_INVALID = "EMAIL_CLIENT_INVALID"
    EMAIL_PAIR_INVALID = "EMAIL_PAIR_INVALID"
