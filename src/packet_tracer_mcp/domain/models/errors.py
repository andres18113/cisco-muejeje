...
class ErrorCode(str, Enum):
    ...
    WIRELESS_ENDPOINT_UNSCOPED = "WIRELESS_ENDPOINT_UNSCOPED"
    WIRELESS_CLUSTER_WITHOUT_CANDIDATE = "WIRELESS_CLUSTER_WITHOUT_CANDIDATE"
    WIRELESS_PLAN_INCONSISTENT = "WIRELESS_PLAN_INCONSISTENT"
    WIRELESS_SELECTION_INVALID = "WIRELESS_SELECTION_INVALID"
    WIRELESS_PARTICIPATION_UNCLASSIFIED = "WIRELESS_PARTICIPATION_UNCLASSIFIED"
    WIRELESS_EVIDENCE_INSUFFICIENT = "WIRELESS_EVIDENCE_INSUFFICIENT"
    WIRELESS_READING_PROVENANCE_CONFLICT = "WIRELESS_READING_PROVENANCE_CONFLICT"
    WIRELESS_BACKEND_AUTHORITY_CONFLICT = "WIRELESS_BACKEND_AUTHORITY_CONFLICT"
