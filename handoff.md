...
The stage differential is now explicit. Floor2 contains 28 new typed actions
(14 DNs and 14 bindings). Its existing Router4 phone-file action expands its
typed dependency set and must run again after those bindings. The correct
mutation set is therefore 29 actions; 46 prior successful actions are retained
to close dependencies, while registration, endpoint addressing, DHCP binding,
