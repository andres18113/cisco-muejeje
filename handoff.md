...
Static projection of the already-compiled later stages now exposes the next
dependency before another canonical run: Router0 introduces 17 PVST mutations
on `3650-24PS` (three global and 14 edge), with three state and three behavior
