...
`docs/reference/cp-scale/current_state.json`. The marked block below remains a
machine-readable compatibility projection for existing consumers. Historical
`KEY = VALUE` prose outside it is not authoritative and must not be parsed as
state.
...
CP_SCALE_CANONICAL_LIVE_RUN = EXECUTED_TWENTY_THREE_TIMES
CANONICAL_CP_SCALE_LIVE_RUN = EXECUTED_TWENTY_THREE_TIMES
CANONICAL_CP_SCALE_LIVE_ATTEMPTS = 23
CANONICAL_CP_SCALE_INVALID_LIVE_ATTEMPTS = 2
CANONICAL_CP_SCALE_BASE_HEAD = 528564493b855ce332f45fdab7b5867a065b1992
CANONICAL_CP_SCALE_PRELIVE_HEAD = 6c6db55566890f1d9ca9cc06bfc13ae24505e793
CANONICAL_CP_SCALE_LIVE_SOURCE_HEAD = 6c6db55566890f1d9ca9cc06bfc13ae24505e793
CANONICAL_CP_SCALE_PHONE_COUNT = 69
CANONICAL_CP_SCALE_VOICE_ACCESS_ACTION_COUNT = 69
CANONICAL_CP_SCALE_STAGE_VOICE_COUNTS = FLOOR1_21 | FLOOR2_35 | FLOOR3_42 | ROUTER0_62 | ROUTER3_69
CANONICAL_CP_SCALE_PRODUCTION_PATH = CONFIRMED_OFFLINE_ALL_STAGES_AND_LIVE_THROUGH_FLOOR3_VOICE
CANONICAL_CP_SCALE_FLOOR1_VOICE = VERIFIED_21_OF_21
CANONICAL_CP_SCALE_FLOOR1_LAST_COMPLETE_VOICE_WINDOW = ENDPOINT_AND_BINDING_VERIFIED_21_OF_21 | SCCP_REGISTERED_21_OF_21
CANONICAL_CP_SCALE_FLOOR1_PHONE_ACCESS_FWD = VERIFIED_21_OF_21
CANONICAL_CP_SCALE_FLOOR1_BINDING_READBACK = RAW_21 | PARSED_21 | EPHONE19_HEADER_INDENTATION_ACCEPTED
CANONICAL_CP_SCALE_FLOOR1_CAPACITY_RESULT = MAX_EPHONES_51_INVALID | MAX_EPHONES_42_REFUTED_FOR_ORDINAL_LOSS
CANONICAL_CP_SCALE_FLOOR1_BINDING_ORDER_RESULT = INDEX1_REFUTED | ORDINAL19_WAS_PAGER_BOUNDARY_OBSERVER_ARTIFACT
CANONICAL_CP_SCALE_FLOOR1_CME_MODE_RESULT = AUTO_REGISTRATION_REFUTED
CANONICAL_CP_SCALE_FLOOR1_LAST_COMPLETE_ENDPOINTS = SVI_21 | DHCP_ENABLED_21 | ADDRESSED_21 | MATCHING_BINDINGS_21 | SCCP_REGISTERED_21
CANONICAL_CP_SCALE_FLOOR1_LAST_COMPLETE_MISSING_RAW_EPHONE_EXTENSIONS = NONE
CANONICAL_CP_SCALE_FLOOR1_CONFIRMED_OBSERVER_DEFECT = EPHONE7_IP_INDENTATION | EPHONE19_HEADER_INDENTATION
CANONICAL_CP_SCALE_FLOOR1_LAST_COMPLETE_BOUNDARY = SCCP
CANONICAL_CP_SCALE_CURRENT_BOUNDARY = FLOOR3_VOICE_SIGNAL_SWITCH9_VLAN20_LRN_AFTER_SINGLE_EXTENSION_ROUTER0_NOT_REACHED
CANONICAL_CP_SCALE_PRIOR_FLOOR2_NETWORK_FOUNDATION = FAILED_3_FRESH_TRUNK_CONTRADICTIONS
CANONICAL_CP_SCALE_FLOOR2_NETWORK_FOUNDATION = VERIFIED
CANONICAL_CP_SCALE_FLOOR2_VOICE = VERIFIED_35_OF_35
CANONICAL_CP_SCALE_FLOOR2_OFFLINE_DIAGNOSIS = COMPLETE
CANONICAL_CP_SCALE_FLOOR2_PRIOR_STAGE_SEMANTICS = CUMULATIVE_REPLAY
CANONICAL_CP_SCALE_FLOOR1_ACTIONS_REAPPLIED_AT_FAILED_FLOOR2 = 115_OF_115
...
CANONICAL_CP_SCALE_FLOOR2_FAILED_RUN_TEMPORAL_EVIDENCE = FRESH_BOUNDARY_LRN_THEN_ATOMIC_REFRESH_FWD
CANONICAL_CP_SCALE_FLOOR2_TIMEOUT_CLASSIFICATION = CONFIRMED_FIXED_BOUNDARY_EXPIRED_DURING_PVST_CONVERGENCE
CANONICAL_CP_SCALE_FLOOR2_NETWORK_ROOT_CAUSE = CONFIRMED
CANONICAL_CP_SCALE_FLOOR2_ROOT_CAUSE_CANDIDATES = RESOLVED_CUMULATIVE_REPLAY_CONTRIBUTOR_PLUS_PVST_BOUNDARY
CANONICAL_CP_SCALE_FLOOR2_CAUSAL_IMPLEMENTATION_HEAD = ff1be60f0dad31a17fdb44d27834d251e2927732
CANONICAL_CP_SCALE_FLOOR2_CONFIGURATION_MUTATION = DELTA_ONLY_76_NEW_ACTIONS
CANONICAL_CP_SCALE_FLOOR2_CONFIGURATION_VERIFICATION = CUMULATIVE_191_EXPECTATIONS_PRESERVED
CANONICAL_CP_SCALE_FLOOR2_TEMPORAL_OBSERVER = ROUND_ROBIN_TRUNK_TRANSITIONS_PLUS_CORRELATED_PVST_BOUNDARIES
CANONICAL_CP_SCALE_FLOOR2_PRODUCT_FIX = VERIFIED_DELTA_ONLY_PLUS_FRESH_PVST_BOUNDARY_ATOMIC_REFRESH
CANONICAL_CP_SCALE_FLOOR2_CAUSAL_LIVE = VERIFIED_NETWORK_FOUNDATION | BOUNDARY_LRN | REFRESH_FWD_9_OF_9 | EXTENSION_NOT_ENGAGED
CANONICAL_CP_SCALE_FLOOR2_DIAGNOSIS_DOC = docs/reference/cp-scale/floor2_network_foundation_root_cause.md
CANONICAL_CP_SCALE_PHONE_ACCESS_GROUPS = 4_VERIFIED | 4_NOT_REACHED
CANONICAL_CP_SCALE_PHONE_ACCESS_FWD = EXPECTED_69 | VERIFIED_42 | FAILED_0 | UNOBSERVABLE_0 | NOT_REACHED_27
CANONICAL_CP_SCALE_REGISTRATION_AFTER_FWD_BARRIER = YES_FLOOR1_FLOOR2_FLOOR3 | NOT_ESTABLISHED_LATER_STAGES
CANONICAL_CP_SCALE_NOT_REACHED_PHONES = 27
CANONICAL_CP_SCALE_FIRST_CONTRADICTED_BOUNDARY = FLOOR3_VOICE_SIGNAL_SWITCH9_VLAN20_PVST_LRN_AFTER_SINGLE_EXTENSION
CANONICAL_CP_SCALE_FAILURE_CLASSIFICATION = OBSERVER_HARNESS_CONVERGENCE_BUDGET
CANONICAL_CP_SCALE_VOICE_VERIFICATION = FAIL
ROOT_CAUSE_STATUS = CAPACITY_MISMATCH_CONFIRMED_AND_CORRECTED
PRODUCTION_FIX_STATUS = CAPACITY_REBALANCE_VERIFIED_CANONICAL_FLOOR3_42_OF_42
CANONICAL_CP_SCALE_SCCP_DIAGNOSTIC_HEAD = bd8e8b80bd170704e3f403263186f0469a4d0839
CANONICAL_CP_SCALE_EPHONE_CAUSAL_CORRECTION_HEAD = dcb156753bce9c5b4559e5c1dc8db6ac323a8f72
CANONICAL_CP_SCALE_BINDING_READBACK_GATE_HEAD = a97e645e479ff72377b8775d3f634e291c507307
CANONICAL_CP_SCALE_BINDING_PAGER_OBSERVER_HEAD = 7d694309ac75df2d3605ce35f5f892279d794aa1
CANONICAL_CP_SCALE_SEMANTIC_BINDING_ORDER_HEAD = 6a81a6f47a9b10b5d16de4c89bc87418aad5b7f6
CANONICAL_CP_SCALE_EXPLICIT_CME_MODE_HEAD = 6fd0a0a69fdd5f9a5054f073ed6534e4a4fc7ee8
CANONICAL_CP_SCALE_ABSENCE_RECONCILIATION_HEAD = a9115cdd65fe467bf54968b1d86c5e6dbcec1aca
CANONICAL_CP_SCALE_DEFERRED_FRONTIER_RECONCILIATION_HEAD = e0e4f8848404ea7d48feedb5d52fb0d0c1cfdf8c
CANONICAL_CP_SCALE_FINAL_SITE_CAPACITY_HEAD = 942f35716d04d89e7f59fbb57bf654dd04bc5e58
CANONICAL_CP_SCALE_GOVERNED_CAPACITY_MODEL_HEAD = e83ae0c431c18b5c6e24bcd424a08c5b45d0270d
CANONICAL_CP_SCALE_BINDING_TERMINAL_DIAGNOSTIC_HEAD = 71715ed2edcb4a306a0537a4e97c1991e503b38a
CANONICAL_CP_SCALE_EPHONE_HEADER_PARSER_CORRECTION_HEAD = 368931c517755766fe69cbda557b85aa25fda6a8
CANONICAL_CP_SCALE_EPHONE_HEADER_PARSER_CORRECTION = VERIFIED_CANONICAL_FLOOR1_21_OF_21
CANONICAL_CP_SCALE_CHECKPOINT_EOF_SOURCE_HEAD = 3c74547c50eba2dfdd0e1ac62a8da696b4ca6934
CANONICAL_CP_SCALE_CHECKPOINT_COMMAND_CHANNEL = EOF_BEFORE_OPERATOR_COMMAND
...
CANONICAL_CP_SCALE_FLOOR2_PVST_BOUNDARY_GATE = VERIFIED_ATOMIC_REFRESH_NO_EXTENSION
CANONICAL_CP_SCALE_FLOOR2_VOICE_MUTATION_PREVIOUS = DELTA_29_RETAINED_46_REACHED_NEW_BINDING
CANONICAL_CP_SCALE_FLOOR2_VOICE_FIRST_FAILURE = NEW_FLOOR2_BINDING_22_PAGER_UNOBSERVABLE_2_OF_2
CANONICAL_CP_SCALE_FLOOR2_VOICE_DELTA = VERIFIED_REPLAY_REFUTED_AS_SUFFICIENT
CANONICAL_CP_SCALE_FLOOR2_GROUPED_BINDING_FRONTIER = VERIFIED_14_OF_14 | ONE_8_PAGE_AUTHORITATIVE_TABLE | NO_RECONCILIATION
CANONICAL_CP_SCALE_PAGER_COMBINED_ROLLOVER = CONFIRMED
CANONICAL_CP_SCALE_PAGER_WINDOW_CORRECTION = VERIFIED_PRODUCTION
CANONICAL_CP_SCALE_PAGER_WINDOW_SAFETY = FULL_CSI_PYTHON_JS_PARITY | ACTIVE_WITH_SYSLOG_TAIL | SYSLOG_ONLY_NOT_PROGRESS | NONEMPTY_SESSION_BASE
CANONICAL_CP_SCALE_CONTROL_PLANE_DELTA = ROUTING_CORE_3 | ROUTER4_SWITCH10_0 | FLOOR1_0 | FLOOR2_0 | FLOOR3_157 | ROUTER0_40 | ROUTER3_17 | FULL_0
CANONICAL_CP_SCALE_FINAL_QUALIFICATION_MUTATION = CONFIGURATION_0 | VOICE_0 | CONTROL_PLANE_0
CANONICAL_CP_SCALE_FINAL_VOICE_QUALIFICATION = RETAINED_SIGNAL_FRESH_DIRECT_FWD_REGISTRATION
CANONICAL_CP_SCALE_CALL_FAILURE_GATE = EXACT_INVENTORY | FAILED_CALL_CONTRADICTS | UNOBSERVABLE_REMAINS_BOUNDED
CANONICAL_CP_SCALE_STAGED_RUNTIME_DELTA_HEAD = 80bbf67ab80f51f01aa64479b49337e1160ee1f0
CANONICAL_CP_SCALE_GROUPED_BINDING_FRONTIER_HEAD = fc401b4d8ee288a8ff5dbd7960ec3bf73021f292
CANONICAL_CP_SCALE_PAGER_TRANSCRIPT_CONTINUITY_HEAD = 3b4da405711ee6859da3f46b737a2003fbf92fb2
CANONICAL_CP_SCALE_FLOOR3_NETWORK_FOUNDATION = VERIFIED
CANONICAL_CP_SCALE_FLOOR3_PRE_REBALANCE_VOICE_EXPECTED = 51
CANONICAL_CP_SCALE_FLOOR3_VOICE_EXPECTED = 42
CANONICAL_CP_SCALE_FLOOR3_VOICE = PRIOR_VERIFIED_42_OF_42 | LATEST_ATTEMPT_BLOCKED_AT_SIGNAL_SWITCH9_3_LRN
CANONICAL_CP_SCALE_FLOOR3_VOICE_MUTATION = DELTA_15 | RETAINED_74
CANONICAL_CP_SCALE_ROUTER0_VOICE_MUTATION = DELTA_45 | RETAINED_89
CANONICAL_CP_SCALE_FLOOR3_ROUTER4_CAPACITY = MAX_EPHONES_42 | MAX_DN_42
CANONICAL_CP_SCALE_FLOOR3_PRE_REBALANCE_NEW_BINDINGS = 36_TO_51_ALL_AUTHORITATIVELY_ABSENT
CANONICAL_CP_SCALE_FLOOR3_PRE_REBALANCE_RECONCILIATION = ATTEMPTED_16_ACCEPTED_16_FINAL_TABLE_STILL_1_TO_35
CANONICAL_CP_SCALE_ROUTER4_CAPACITY_MISMATCH = CONFIRMED_51_PHONES_GT_42
...
STP_PVST_QUALIFICATION_RUN3_HEAD = 29afd03bdd215d16b5d2e7c9eef5ea53e4a521c1
STP_PVST_QUALIFICATION_RUN3_RESULT = CONFIG_STATE_BEHAVIOR_VERIFIED_FLOOR3_MODELS
STP_PVST_QUALIFICATION_RUN3_OBSERVATIONS = 3560_STATE_BEHAVIOR_VERIFIED | 2960_STATE_BEHAVIOR_VERIFIED
...
STP_PVST_ROUTER0_3650_REQUIREMENT = MUTATIONS_17 | STATE_EXPECTATIONS_3 | BEHAVIOR_EXPECTATIONS_3 | EXACT_MODEL_CAPABILITY_SUPPORTED
...
STP_PVST_TYPE_SPLIT_HEAD = ed386bcd37f52854e0b966cb1a1da248337fbb00
STP_PVST_TYPE_SAFETY = GLOBAL_STP_PVST_CONFIG_SEPARATE_FROM_EDGE_STP_EDGE_CONFIG
STP_PVST_QUALIFICATION_RUN5_HEAD = ed386bcd37f52854e0b966cb1a1da248337fbb00
STP_PVST_QUALIFICATION_RUN5_RESULT = CONFIG_EDGE_STATE_BEHAVIOR_VERIFIED_EXACT_THREE_MODELS
STP_PVST_QUALIFICATION_RUN5_MUTATIONS = GLOBAL_3560_2960_3650_APPLIED | EDGE_3560_3650_APPLIED | EDGE_2960_NOT_EXERCISED
STP_PVST_QUALIFICATION_RUN5_STATE = THREE_OF_THREE_VERIFIED
STP_PVST_QUALIFICATION_RUN5_BEHAVIOR = THREE_OF_THREE_VERIFIED_TWO_IDENTICAL_STABLE_SAMPLES
STP_PVST_QUALIFICATION_RUN5_CAPABILITY = 3560_PVST_EDGE_STATE_BEHAVIOR_SUPPORTED | 2960_PVST_STATE_BEHAVIOR_SUPPORTED_EDGE_UNKNOWN | 3650_PVST_EDGE_STATE_BEHAVIOR_SUPPORTED
STP_PVST_CONFIG_STATUS_BY_MODEL = 3560-24PS_SUPPORTED | 2960-24TT_SUPPORTED | 3650-24PS_SUPPORTED
STP_EDGE_CONFIG_STATUS_BY_MODEL = 3560-24PS_SUPPORTED | 2960-24TT_UNKNOWN | 3650-24PS_SUPPORTED
STP_STATE_STATUS_BY_MODEL = 3560-24PS_SUPPORTED | 2960-24TT_SUPPORTED | 3650-24PS_SUPPORTED
STP_BEHAVIOR_STATUS_BY_MODEL = 3560-24PS_SUPPORTED | 2960-24TT_SUPPORTED | 3650-24PS_SUPPORTED
STP_PVST_QUALIFICATION_RUN5_SHA256 = 3e1b9e4fc2a4eab5e26622250eec4a724a3e5dd029406f510730d485a1550edd
STP_PVST_QUALIFICATION_RUN5_CLEANUP = ZERO_SEMANTIC_DEVICES_LINKS_TWICE | REALTIME_VERIFIED | INDEPENDENT_ZERO_SEMANTIC_DEVICES_LINKS_TWICE_REALTIME_VERIFIED
STP_PVST_UNMEASURED = RAPID_PVST_UNKNOWN | MST_UNKNOWN | FAILOVER_UNKNOWN | UNRELATED_DIMENSIONS_UNKNOWN
...
LIVE_RUNS_CONSUMED = AT_LEAST_46_NON_EXHAUSTIVE_AFTER_20260903
CLEANUP = LATEST_POE_ACQUISITION_CLEANUP_4_OF_4 | PTS_INTEGRITY_VERIFIED | SESSION_REUSABLE
WORKSPACE_RESTORED = SEMANTIC_INVENTORY_YES | PHYSICAL_PTS_VERIFIED
NEXT_ACTIVE_STEP = POE2_ACCESSPOINT_PT_USING_THE_CALIBRATED_PSE_OBSERVABLE
POE_INLINE_OBSERVABLE = CALIBRATED_EXACT_BINDING_3560_24PS_FA0_1_7960_SWITCH | NEVER_IS_ROW_ABSENCE | SUMMARY_NOT_AUTHORITY | NO_PORT_EXTRAPOLATION
CP_SCALE_STATUS = PRIOR_POE_EXACT_BINDING_VERIFIED | FACTORY_STRUCTURE_OBSERVED_NO_PROMOTION | ROUTER0_OPERATOR_AUTHORIZED_ONE_UNCONSUMED | PRODUCT_PRECONDITION_BLOCKED
<!-- CP_SCALE_STATE_END -->
...
## Floor2 delta-only causal LIVE prepared

The separately authorized single-variable implementation is commit
`ff1be60f0dad31a17fdb44d27834d251e2927732`. It does not change topology,
VLAN intent, Voice ordering, control-plane policy, timeout, or acceptance
criteria. Canonical stage projections remain cumulative, but their mutation
scope is now the stable action-ID difference from the preceding VERIFIED
stage. At Floor2 that is exactly 76 new actions; all 115 Floor1 action results
are retained for dependency closure and all 191 Floor2 expectations are read
again.

The configuration observer now samples every trunk expectation round-robin,
retains every allowed/active/forwarding transition, and correlates each
transition with fresh `show spanning-tree` roots and relevant port states.
Separate read-only snapshots are retained before and after the physical delta
and after configuration phases 20 and 30. Missing, stale, incomplete, or
ambiguously attributed output remains non-authorizing.

No LIVE has yet run from this implementation, so the Floor2 root cause remains
`STRONG_CANDIDATE`, not `CONFIRMED`; the code is a causal candidate, not yet a
verified production correction. The full governed suite passes
`3457 passed, 2 skipped`.

## Floor1 SCCP divergence blocked the Floor2 causal question

The governed run
`canonical-cp-scale-voice-20260901T010136612890Z-2976329769f9` used pushed
source `2976329769f9747fa819935f851742b300f81333`. One earlier invocation
hard-stopped before mutation because the MCP BUILDER webview was not polling;
the window was reopened through Packet Tracer, authenticated `pt-sm:` polling
was verified, and the valid run then started from two fresh zero-device
inventories.

MEASURED FACT: Floor1 again completed the corrected lifecycle through
`PHONE_ACCESS_FWD_VERIFIED`, this time with all 21 interfaces authoritative
after 35 grouped samples and 43,016 ms. All 21 phones exposed `Vlan20`, DHCP
enabled, and a non-empty `172.16.20.x` address. Router4 exposed exactly 21 Voice
DHCP bindings and every endpoint address matched one.

MEASURED FACT: after the full 180-second registration episode, a fresh complete
five-page `show ephone` table exposed 19 registered extensions and omitted
exactly `3001` and `3007`. Those two endpoints held `172.16.20.18` and
`172.16.20.2` respectively and both addresses had matching server bindings.
The run therefore supplied no evidence against the corrected Voice dependency;
it exposed the previously recorded 3001/3007 anomaly before Floor2 could begin.

OBSERVER DEFECT: the immutable run artifact reports `ENDPOINT_ADDRESS` because
the canonical correlator required the SCCP table's IP field to call an endpoint
address verified. That collapses two independent facts. Commit
`bd8e8b80bd170704e3f403263186f0469a4d0839` keeps the endpoint-SVI plus matching
DHCP binding proof at 21/21 and localizes the open boundary to SCCP without
weakening SCCP closure.

The same commit retains, per stage, every measured phone MAC, the exact trusted
ephone IOS batch, and each raw/hash-qualified `show ephone` transition. This is
the minimum next LIVE change needed to decide among a missing/wrong binding
mutation, a raw table that truly omits the ephones, and a parser/pager observer
loss. It changes no topology, timeout, DHCP state, Voice order, or acceptance
criterion. Floor2 received no causal evidence and remains `STRONG_CANDIDATE`.

The immutable run artifacts are pinned by SHA-256:
...
Cleanup independently verified zero semantic devices and zero links twice, and
Realtime restoration verified with no error.

## Raw SCCP diagnostics split observer and product failures

The next governed run
`canonical-cp-scale-voice-20260901T013000402201Z-144ebaa65c5f` used pushed
source `144ebaa65c5fbc7f6cf268ee97d8cf5f13ad10cc` and reproduced the Floor1
SCCP stop after the same verified network, 21 endpoint addresses, and 21
matching Voice DHCP bindings.

MEASURED FACT: the retained raw five-page table contains `ephone-7`, registered
at `172.16.20.2`. Its `IP:` line has leading whitespace and the parser required
column zero, so the parser omitted a row that raw IOS actually exposed. This is
a confirmed OBSERVER defect. The correction accepts whitespace before `IP:`
without weakening the numeric ephone, MAC, extension, or registration parsing.

MEASURED FACT: `ephone-1` is different. Its measured phone MAC
`000A.F3B3.58A3` is unique among all 21 Floor1 phones. The exact trusted
phase-40 payload contains `ephone 1`, that MAC, type `7960`, and
`button 1:1`. The containing 109-line batch was accepted, but none of 33 raw
registration samples contains `ephone-1`. The first product divergence is
therefore the binding mutation/readback boundary, not SCCP polling.

The next causal implementation is commit
`dcb156753bce9c5b4559e5c1dc8db6ac323a8f72`. It preserves phase and stable
action order but gives each independent `BindPhoneToExtension` action one typed
`configureIosDevice` batch. This is not a retry: every action is still
dispatched exactly once. It adds no sleep, raw CLI, DHCP mutation, endpoint
toggle, PortFast policy, or CP-SCALE special case.

The immutable diagnostic artifacts are pinned by SHA-256:
...
Cleanup again independently verified zero semantic devices and zero links
twice, with Realtime restored. Floor2 still was not reached, so its root cause
remains `STRONG_CANDIDATE`.

## One-action binding batches refuted; mutation completion is now gated

The governed run
`canonical-cp-scale-voice-20260901T015150996119Z-4802eb6de95b` used pushed
source `4802eb6de95b333390324f989eb4ee5acf4043af`. Floor1 again verified all
21 access ports, endpoint Voice addresses, and matching DHCP bindings. The
fixed parser correctly retained registered `ephone-7`; raw and parsed SCCP
counts both reached 20. Only `ephone-1` remained absent from 35 raw samples.

MEASURED FACT: the renderer produced 21 phase-40 batches with exactly one
binding action and nine IOS lines each. `ephone-1` still did not exist in raw
readback. Therefore renderer batch size is `REFUTED_AS_SUFFICIENT`.

SOURCE FACT: the webview drains every queued HTTP command into one `runCode`
batch. Separate renderer calls do not prove that one mutation completed before
the next was accepted. The surviving defect is the absence of a mutation
completion dependency: binding N+1 could dispatch while binding N remained
unverified.

Commit `a97e645e479ff72377b8775d3f634e291c507307` implements the next causal
boundary. Each typed phone binding is dispatched once, followed by one fresh,
complete, uniquely attributed `show ephone` readback of its exact directory
index, extension, and measured MAC. Only a verified row authorizes the next
binding. An absent row records APPLIED plus `VERIFICATION_FAILED`, blocks later
unsent actions, and never replays the ambiguous mutation. No sleep, retry,
DHCP change, or raw command path was added.
...
Cleanup again verified zero semantic devices and zero links twice and restored
Realtime. Floor2 was not reached and remains causally unresolved.

## Binding gate stopped on qualified pager evidence

The governed run
`canonical-cp-scale-voice-20260901T021410113093Z-6b7a9d37d81b` used pushed
source `6b7a9d37d81bb1a5c6dd7819b71f22756820b71f`. The new gate verified the
exact directory index, extension, and measured MAC for the first 11 binding
mutations. It then dispatched the binding for extension `3006` / ephone 6 and
received a fresh, source-attributed but pager-incomplete read
(`rolled_unattributable`). It blocked the remaining nine bindings before Voice
signal or registration.

This is a valid OBSERVER stop, not evidence that ephone 6 was absent. The query
was read-only, the binding was not replayed, and no later mutation was allowed
through UNKNOWN.

Commit `7d694309ac75df2d3605ce35f5f892279d794aa1` allows exactly one extra
`show ephone` only when the prior read proves all of: executed, fresh,
pager-truncated, incomplete, continuation failed, correct device, and unique
source attribution. A complete missing or mismatched row is never retried, and
the binding mutation is never repeated. Both read attempts are retained.
...
Cleanup verified zero semantic devices and zero links twice and restored
Realtime. The ephone-1 product question and Floor2 causal question were both
not reached.

## Qualified observer confirms complete ephone-1 absence

The governed run
`canonical-cp-scale-voice-20260901T023109308451Z-f1cf32ad7391` used pushed
source `f1cf32ad7391a560f13d0a57cc870ca158d1c7ce`. The qualified observer
crossed the prior pager failure and verified the first 18 exact binding rows.
It then dispatched ephone 1 once with measured MAC `00D0.FF98.B669`.

MEASURED FACT: the immediate readback was executed, fresh, complete across five
pages, and uniquely attributed to Router4. It contained ephone indices
2-11 and 14-21 but no ephone 1. Because this was an authoritative complete
absence, the observer did not retry. Bindings 12 and 13 remained unsent and
Voice signal never occurred.

This confirms the product mutation/readback divergence for ephone 1. It does
not yet establish why that specific action is lost. Under the existing stable
hash-ID order, directory index 1 is the nineteenth binding. The next
single-variable experiment changes only binding order to semantic directory
index, making ephone 1 the first state-gated binding while preserving every
other action, MAC, phase, and verification contract.

Commit `6a81a6f47a9b10b5d16de4c89bc87418aad5b7f6` implements that generic order;
there is no CP-SCALE or ephone-1 special case.
...
Cleanup again verified zero semantic devices and links twice and restored
Realtime. Floor2 remained not reached.

## Governed capacity 42 refuted for the ordinal loss

The governed run
`canonical-cp-scale-voice-20260901T041940173800Z-b777036b925b` used pushed
source `b777036b925b857a71208e35288f2324e5602e74` and rendered Router4's
documented `max-ephones 42 / max-dn 42`. The final raw and parsed tables agreed
exactly on 20 rows—1-18,20,21—and ephone 19 remained absent after its one
post-frontier reconciliation.

Capacity 42 is therefore valid enough to create the table but refuted as the
cause of the ordinal binding loss. Capacity 51 remains independently invalid.

The mutation channel still reported only that `configureIosDevice` was queued;
its IOS response was gone before the operational readback began. Commit
`71715ed2edcb4a306a0537a4e97c1991e503b38a` now records a read-only terminal
snapshot immediately after each typed binding and reconciliation. It retains a
full-output SHA-256 and a bounded exact 16 KiB tail, uses the already-governed
`getCommandLine().getOutput()` surface, and does not affect progression.
...
## Pager continuity closes Floor2 35/35; Floor3 confirms CME capacity defect

The governed run
`canonical-cp-scale-voice-20260901T120836292077Z-2bf6876f0fd2` used clean
pushed source `2bf6876f0fd2735e9f62ee7dccb58880ae817c0d`. Floor1 verified
21/21. Floor2's 14-binding grouped frontier completed in one authoritative
eight-page read with no reconciliation, then all 35 cumulative phone ports
reached FWD and all 35 phones matched endpoint IPv4, DHCP binding, and SCCP.
Floor2 checkpointed successfully.

This confirms both the combined head-roll/tail-rewrite mechanism and the
pre-marker transcript correction in production.

Floor3 then verified its 110-device/73-link physical delta and cumulative
network foundation. Its exact 33-action Voice delta attempted new directory
indices 36-51 on Router4, whose authoritative design declares
`max-ephones 42 / max-dn 42` for 51 physical phones. The initial complete table
contained only 1-35. All 16 absences received their one typed reconciliation;
all 16 calls were accepted, and the final complete table remained exactly
1-35. Voice signal stayed closed.

The documented `CME-OBS-001` is therefore confirmed at the first production
stage where it matters. The 69-phone acceptance contract cannot be weakened to
42. The next causal step is a governed disposable qualification of a Packet
Tracer router model whose Cisco-supported CME capacity exceeds 51, followed by
the minimum canonical Router4 model/interface/module correction if the exact
build verifies it.

The immutable artifacts are pinned by SHA-256:

- failure pre-cleanup:
  `e8f94de67cd621b820be5de7d19405d00304ca3456c85db1d3deebbd7f7e78ef`;
- cleanup:
  `41a313b037c6d6c2083fabc3ee33d3fa4182473e193ce848df042266b20ac8fa`.

Cleanup verified zero semantic devices and links twice and restored Realtime.

## Disposable CME model qualification -- 2911 negative, wrapper corrected

A governed disposable `supports_cme` probe ran from clean pushed source
`2410958d08f28f0a4a226bf6807e3282678f090e`. Packet Tracer created and
configured the `2911`, verified its model/configuration/L3/port prerequisites,
but `show ephone` exposed no parseable row after the controlled CME
configuration. The exact-build result is
`supports_cme = UNKNOWN / VERIFY_FAILED`, not a supported candidate for the
51-phone Router4 correction.

The discovery service deleted its base, L3, and CME probe devices and its
snapshot reports identical initial/final inventories. The wrapper then failed
while trying to serialize a nonexistent `ProbeSessionResult.cleanup` field.
That is a HARNESS failure after the valid 2911 result, not a reason to rerun
2911. A separate read-only bridge session observed zero semantic devices and
zero links twice.
...
The corrected wrapper reads `inventory_restored`,
`cleanup_deleted`, and `cleanup_failed` from their actual schema locations and
will test only the not-yet-run ISR4321/ISR4331 candidates.

The corrected follow-up then tested both ISR candidates without rerunning 2911.
`ISR4321` and `ISR4331` each verified model existence, configuration channel,
L3, and port inventory, but each returned
`supports_cme = UNKNOWN / VERIFY_FAILED` because the controlled configuration
produced no parseable ephone row. Service cleanup restored each probe inventory,
and the wrapper independently observed zero semantic devices and links twice.
The exact evidence SHA-256 is
`b32099fc9e2dfc88b3bc295c1361b730a2b4ab87f1312f6943642594e9f6823b`.

No catalog platform with Cisco capacity above 51 has a verified CME readback on
this Packet Tracer build. The minimum viable correction therefore uses the
three already-proven 2811 CMEs: move the nine overflow phones from Router4's
last Floor3 block to unused PoE ports in the Router0 branch, set the resulting
capacities to Router4=42, Router0=20, Router3=7, and retain 314 devices, 219
links, and 69 phones. Router0's `/24` Voice segment and access switches have
ample measured capacity; no new device, link, VLAN, API, or call-control model
is introduced.

## Capacity rebalance verifies Floor3 42/42; exact-model STP evidence is next

The governed run
`canonical-cp-scale-voice-20260901T133350798961Z-5373539f0b1f` used clean
pushed source `5373539f0b1fe428e77c2549a00f477717f13af6`. Floor1 again
verified 21/21 and Floor2 35/35. The corrected Floor3 projection then deployed
232 cumulative devices and 160 links, verified its network foundation, and
completed the full Voice lifecycle for all 42 Router4 phones: 42 phone ports
FWD, 42 addressed endpoints, 42 matching DHCP bindings, and 42 SCCP
registrations. The capacity correction is therefore production-verified rather
than merely implemented.

The first new divergence was the Floor3 control-plane capability boundary.
All three retained RIPv2 actions and all 12 retained RIPv2 observations
verified. Before dispatching any new STP mutation, the fail-closed gate skipped
156 `3560-24PS` actions and one `2960-24TT` action because
`stp_pvst_config` remains UNKNOWN for both exact models. Nine STP state and nine
STP behavior expectations were dependency-blocked. This is a capability
evidence gap, not evidence that Packet Tracer rejected STP or that the observer
misread it.

The valid negative authorizes one bounded disposable qualification using the
same typed STP renderer, mutation runtime, and fresh `show spanning-tree`
observer on exactly those two models. Another canonical LIVE is not authorized
until that result changes the capability decision.

Immutable SHA-256:

- failure pre-cleanup:
  `e5a8e0ddf05c905d468227a61adc17bf6c9f9c367a7ff15080aaf494011c6dc1`;
- cleanup:
  `57c428a9ad5afe4d5f9d39e02b83498d274241c25b54fdd6efd3ac322237babe`.
...
The observer-qualified run
`stp-pvst-capability-20260901T150150452540Z-29afd03bdd21` used clean
pushed source `29afd03bdd215d16b5d2e7c9eef5ea53e4a521c1`. It retained the
same three accepted mutations and exact root relationship, then returned four
fresh typed results: `STP_STATE` and `STP_BEHAVIOR` VERIFIED on both the
`3560-24PS` and `2960-24TT`. Behavior used
`fresh_show_spanning_tree_stable_roles`, not ping; every claimed
`source_device_name`, `loop_free`, and `forwarding_converged` field verified.
Zero-instance reads remain UNOBSERVABLE, LIS/LRN is reobserved without
redispatch, and stable role/state contradictions fail immediately.
...
At that point, static projection of the already-compiled later stages exposed
the next dependency before another canonical run: Router0 introduces 17 PVST
mutations on `3650-24PS` (three global and 14 edge), with three state and three
behavior expectations. That exact model remained UNKNOWN. The same bounded
qualifier was therefore extended with one 3650 branch; no Floor3 capability was
inferred onto it.
...
## Stable typed three-model PVST qualification closes this unit

The governed run
`stp-pvst-capability-20260902T002049264918Z-ed386bcd37f5` used clean,
pushed source `ed386bcd37f52854e0b966cb1a1da248337fbb00` on Packet
Tracer 9.0.1.0858 in Realtime. Its read-only preflight found zero semantic
devices, zero links, and no unowned/manual semantic topology. This source also
separates the global `STP_PVST_CONFIG` contract from the edge-only
`STP_EDGE_CONFIG` contract; PortFast/BPDU Guard can no longer be authorized by
the global mode capability.

All five typed STP mutations applied: global PVST on the exact `3560-24PS`,
`2960-24TT`, and `3650-24PS`, plus edge PortFast/BPDU Guard only on the
`3560-24PS` and `3650-24PS`. All three fresh state observations verified. All
three behavior observations also verified after exactly two consecutive
identical stable role/state samples, with the sampled transitions retained.

The resulting exact boundary is:

* `3560-24PS`: `STP_PVST_CONFIG`, `STP_EDGE_CONFIG`, `STP_STATE`, and
  `STP_BEHAVIOR` SUPPORTED.
* `2960-24TT`: `STP_PVST_CONFIG`, `STP_STATE`, and `STP_BEHAVIOR` SUPPORTED;
  `STP_EDGE_CONFIG` UNKNOWN because no edge action was exercised.
* `3650-24PS`: `STP_PVST_CONFIG`, `STP_EDGE_CONFIG`, `STP_STATE`, and
  `STP_BEHAVIOR` SUPPORTED.

Rapid-PVST, MST, failover, and unrelated dimensions remain UNKNOWN. Evidence
SHA-256:
`3e1b9e4fc2a4eab5e26622250eec4a724a3e5dd029406f510730d485a1550edd`.
The run restored zero semantic devices and zero links in two fresh inventories
and verified Realtime. A separate post-run process independently repeated two
fresh inventories with zero semantic devices and links and independently
verified Realtime. No canonical CP-SCALE stage was resumed; this PVST unit is
stopped for review.

## Grouped frontier isolates combined pager rollover

The governed run
`canonical-cp-scale-voice-20260901T095242336005Z-7ea42ee7d5db` used clean
pushed source `7ea42ee7d5db1a633639b2280eec24f2f041493d`. Floor1 and the
Floor2 network foundation verified. Floor2 dispatched all 14 new bindings once
before one grouped logical table read, and no later Voice phase ran.

Both allowed attempts failed at page three with
`rolled_unattributable`. Each was executed, fresh, and uniquely attributed, but
neither was complete. The last partial window contained indices 1-14. No
authoritative absence, mismatch, reconciliation, or product mutation result was
claimed. Grouping therefore removes per-binding query multiplication but is
not sufficient while the pager window itself loses attribution.

The source mechanism is narrow. `fresh_command_window()` already handles
`--More--` tail erasure while the transcript head remains stable, and it
handles head roll while the old tail remains stable. At page three the terminal
crosses its retained-buffer boundary while also erasing the pager marker. The
old suffix candidate still includes the erased `--More--`, so it cannot match
the otherwise retained prefix and reports `rolled_unattributable`.

Commit `3b4da405711ee6859da3f46b737a2003fbf92fb2` adds one exact strategy:
`PAGER_ROLLED_SUFFIX_ANCHOR`. It removes only a recognized terminal-owned
trailing `--More--` from the prior transcript, then requires an exact retained
512-byte-or-longer, line-bearing session-transcript suffix/prefix overlap—the
same anchor size already used for execution attribution. Once a pager tail is
recognized, a failed guarded match cannot fall through to the generic rollover
path. Foreign marker text, shared IOS lines, and one-character collisions stay
unattributable. Python and the atomic JavaScript guard now share the full CSI
grammar; recognized async syslogs after `--More--` preserve pager state, while
syslog-only, marker-erasure, ANSI-only, and partial-page changes never count as
page progress. Empty session bases are non-authorizing. Fail-first tests cover
those adversarial cases, the combined rewrite directly, and a four-page rolling
terminal end to end.

The immutable artifacts are pinned by SHA-256:

- failure pre-cleanup:
  `b7a71e20e77e83f658b0d1b062fe5c78b149b34f2ac26eb62aba3f9a91d31ccb`;
- cleanup:
  `cbfba0ad0135c6d79b2feafe7fd12e3dbc318d44ad77b18c9ef037d907bfd88d`.

Cleanup verified zero semantic devices and links twice and restored Realtime.

## Voice delta reaches new binding; per-binding global table is unobservable

The governed run
`canonical-cp-scale-voice-20260901T085436828856Z-b9da148c8b37` used clean
pushed source `b9da148c8b37303261533553d00666708fb99bb0`. Floor1 and the
Floor2 network foundation verified. The stage evidence pinned the intended
partitions: configuration 76/115, Voice 29/46, and control plane 0/3
mutation/retained.

Voice delta-only mutation applied all 14 new Floor2 DNs and then dispatched
directory index 22, the first genuinely new binding, without replaying any
Floor1 binding. This refutes cumulative Voice replay as sufficient for the
bootstrap stop.

The next observer boundary is the global paged `show ephone` table after each
individual binding. The index-22 mutation was sent exactly once. Its two
permitted read-only reads were executed, fresh, and uniquely attributed, but
pager continuation lost transcript attribution after three pages and four
pages respectively. Neither read was complete; the last partial window exposed
indices 1-18 only. The runtime therefore made no absence or mutation claim,
attempted no reconciliation, and blocked bindings 23-35.

Commit `fc401b4d8ee288a8ff5dbd7960ec3bf73021f292` changes observer
granularity, not authority. All 14 typed Floor2 bindings are dispatched once,
then one grouped logical table read must simultaneously match each new
directory index, extension, and measured MAC. A complete mismatch fails; a
complete absence retains the single absence-driven reconciliation path;
incomplete or unattributed tables fail closed after the same one safe
read-only retry. Any failure blocks later Voice phases across applicator
calls. Registration, access FWD, endpoint IPv4, DHCP binding, and SCCP remain
cumulative for all 35 phones.

The immutable artifacts are pinned by SHA-256:

- failure pre-cleanup:
  `aeb2ffaa65ffe9b5ab8187f5086be1f86271eafbb7d471a1ddfa19d09fa9d94e`;
- cleanup:
  `17b74aa4fcbaaa7a9526d736859d4af3799fd571d1cae5d4d31a01c7fa23abef`.

Cleanup verified zero semantic devices and links twice and restored Realtime.

## Floor2 network verifies; cumulative Voice replay stops before new bindings

The governed run
`canonical-cp-scale-voice-20260901T071703181436Z-fe725ac177d2` used clean
pushed source `fe725ac177d2ea452cfd52da6d81994fbd2a894c`. Routing core,
Router4-Switch10, and Floor1 again verified and advanced.

Floor2 closed the network causal question. The initial trunk gate took 38
round-robin samples. Its fresh boundary snapshot found Switch6 Gi0/1 and Gi0/2
and Switch10 Fa0/2 authoritatively `LRN`, while Switch7 Gi0/1 was already
`FWD`. The mandatory atomic trunk refresh immediately afterward verified all
nine trunk expectations at sample 39 and 49,937 ms. The optional 20-second
continuation did not engage. This confirms the fixed observer boundary as the
remaining Floor2 network cause and verifies the delta-only plus fresh-boundary
atomic-refresh correction.

The first new divergence moved to Floor2 Voice bootstrap. The cumulative
75-action Voice plan was still passed entirely to mutation with zero retained
actions. After the service and 35 extension actions, it replayed directory
index 1—the already verified Floor1 binding—before any new Floor2 binding.
Both permitted read-only readbacks were executed, fresh, uniquely attributed,
and pager-continuation failures; neither was complete, so no absence,
mismatch, or product loss was claimed. Reconciliation correctly remained
closed, the other 34 bindings were dependency-blocked, and no new Floor2
binding was dispatched.

Commit `80bbf67ab80f51f01aa64479b49337e1160ee1f0` makes the stage
differential explicit. Floor2 contains 28 new typed actions (14 DNs and 14
bindings). Its existing Router4 phone-file action expands its typed dependency
set and must run again after those bindings. The correct mutation set is
therefore 29 actions; 46 prior successful actions are retained to close
dependencies, while registration, endpoint addressing, DHCP binding,
phone-access FWD, and SCCP remain cumulative for all 35 phones. Later stage
deltas are likewise bounded: Floor3 33/74, Router0 27/107, Router3 19/134, and
full qualification zero/153 mutation/retained.

Control-plane mutation now follows the same retained-fact contract: routing
core mutates its three RIPv2 actions once; Router4-Switch10, Floor1, and Floor2
mutate zero; Floor3 mutates 166 new STP actions, Router0 31, Router3 17, and
full qualification zero. Full qualification therefore performs zero
configuration, Voice, or control-plane action mutations. It freshly verifies
the retained Voice signal and all phone-access FWD rows before cumulative
registration, then performs read-only control-plane verification. Failed call
results or an inexact call-result inventory now contradict canonical Voice;
unsupported/unobservable calls remain explicitly bounded rather than promoted
...
## Floor2 delta preserves prior trunks; new PVST ports expire in LEARNING

The governed run
`canonical-cp-scale-voice-20260901T055647792755Z-0ec4bdade3bb` used clean
pushed source `0ec4bdade3bb1e2dd1e9b022a95dd0459da9cc50`. Routing core,
Router4-Switch10, and Floor1 all verified and advanced; Floor1 again closed
Voice 21/21. Its three RIPv2 process reads verified on their first attempts, so
the qualified pager retry was available but did not engage.

Floor2 reached the intended causal experiment. Its 59-binding physical delta
contained 58 new devices plus the existing Switch10 anchor and 41 new links;
physical verification passed. Configuration mutated exactly 76 new action IDs,
retained 115 verified Floor1 application facts, and freshly evaluated all 191
cumulative expectations.

MEASURED FACT: every previously verified Floor1 trunk remained forwarding.
Five of nine cumulative trunk expectations passed, including both Switch4
trunks, Switch5 Gi0/1, and Switch10 Fa0/1/Gi0/1. The four new path interfaces
failed only forwarding: Switch10 Fa0/2, Switch6 Gi0/1 and Gi0/2, and Switch7
Gi0/1 were all fresh, complete, uniquely attributed, trunking, allowed, and
active for VLANs 10,20,30.

The retained PVST evidence identifies progression rather than guessing a
terminal state. Immediately after L2 interface activation the new ports were
LISTENING; Switch6 was temporarily local root for VLAN20 while the domain
converged. The latest correlated snapshots for the four pending interfaces,
at rounds 23, 31, and 33, had settled on Switch4
(`0002.162A.078A`) and showed every expected VLAN port in `LRN`; no retained
sample was blocking. The terminal trunk sample was round 35 at 45,766 ms, but
PVST was not freshly sampled at that exact boundary. Exact IOS output reported
`Forward Delay 15 sec`.

This answers the original hypotheses. Delta-only mutation receives causal
credit for preserving the old trunks, so cumulative replay contributed to the
prior regression but was not sufficient to explain all of Floor2. Natural PVST
...
## Floor1 Voice verifies 21/21; RIP process pager observer stops the stage

The governed run
`canonical-cp-scale-voice-20260901T051758574307Z-ac6012f6a759` used clean
pushed source `ac6012f6a759c05541727d70046ab497bdc655a2` and persistent
checkpoint input. Routing core and Router4-Switch10 both verified and advanced.

MEASURED FACT: the ephone header parser correction closed canonical Floor1
Voice completely. Voice bootstrap applied and signal verified; Switch5/VLAN20
authoritatively reached FWD on all 21 phone ports after 72 samples and
36,046 ms; all 21 phones exposed the Voice SVI with DHCP enabled, all 21 had
IPv4, all 21 matched authoritative DHCP bindings, and all 21 registered via
SCCP. Registration started only after the FWD barrier. No Voice boundary
contradicted.

The next first divergence was Floor1 control-plane observation. All three typed
RIPv2 actions were accepted, Router4's process readback verified, and all nine
required RIP route expectations verified. Router0 and Router3 process
readbacks were pager-truncated, so the runtime correctly classified them
UNOBSERVABLE and the stage failed closed as `partial/none`. No RIP product
contradiction was observed, and Floor2 did not start.

Commit `6bf0b8e3a5dbd6899226c1eaaf04ef2011c69b89` reuses one shared policy
already proven by Voice: at most one additional read-only query is permitted
only when the first result proves executed, fresh, incomplete,
pager-truncated, continuation-failed, and uniquely attributed to the expected
device. A mutation is never retried. The control-plane result retains a
two-attempt `ConvergenceReport` with first/final pager authority dimensions so
the next LIVE can prove whether the policy engaged and whether it closed the
observer.
...
## Routing-core checkpoint EOF is a harness invocation failure

The governed runner started from clean pushed source
`3c74547c50eba2dfdd0e1ac62a8da696b4ca6934` as
`canonical-cp-scale-voice-20260901T051218175698Z-3c74547c50eb`. It verified
the three-device/three-link routing core, cumulative configuration, RIPv2
control plane, core forwarding, and two workspace observations, then emitted
`CHECKPOINT_READY` for `routing-core`.

The non-interactive shell invocation had closed stdin. The runner's next
`input()` therefore raised `EOFError` before receiving either governed command
(`continue` or `retain`). This is a HARNESS failure at
`ROUTING_CORE_CHECKPOINT_COMMAND_CHANNEL`, not a product result. Floor1 did not
exercise the ephone header correction and Floor2 received no evidence.

The runner caught the failure and independently verified cleanup: both
post-cleanup observations contained zero semantic devices and zero links, and
Realtime restoration passed. The next invocation changes only transport of the
already-governed checkpoint commands: persistent stdin supplies exactly nine
`continue` tokens for the seven build stages, `remaining`, and
`full-qualification`. It does not change topology, product source, timeouts, or
verification.
...
## Terminal diagnostic confirms pager-boundary ephone header parser defect

The governed run
`canonical-cp-scale-voice-20260901T043604861347Z-86603be911bf` used pushed
source `86603be911bf8da453bf2d7c93c924226ae5fd41` with Router4's governed
capacity 42 and the bounded terminal snapshots added at
`71715ed2edcb4a306a0537a4e97c1991e503b38a`.

MEASURED FACT: the initial directory-index 19 readback was executed, fresh,
complete across five pages, and uniquely attributed to Router4. Its raw output
already contained the exact expected row:

```text
 ephone-19 Mac:0005.5E3E.3231 ... UNREGISTERED
...
 button 1: dn 19 number 3019 CH1 DOWN
```

The header had one leading space at the pager boundary. The parser accepted
only `ephone-` at column zero, so it dropped the complete block and fabricated
an authoritative absence. The later complete raw table contained indices
1-21, including the same indented row 19, while the old parser returned
1-18,20,21. Replaying the archived raw windows after allowing only leading
horizontal whitespace before the otherwise strict header yields all 21 rows.

This evidence refutes the ordinal-19 product-mutation loss. It also explains
why changing binding order moved the apparent failure to the nineteenth
binding and why accepted reconciliation could not repair it: ordinal 19 is the
page-boundary row the observer discarded, not a missing CME object. The
previous capacity, ordering, mode, and reconciliation runs remain valid
historical negatives for their stated interventions, but they no longer
support a missing-mutation root cause.

Commit `368931c517755766fe69cbda557b85aa25fda6a8` limits the correction to
`parse_show_ephone()`: it accepts spaces or tabs before a strict ephone header,
just as the prior measured correction accepts indentation before `IP:`. MAC,
registration, extension, and line-state parsing remain fail closed. The exact
pager-boundary shape has a fail-first regression test. No topology, Voice
lifecycle, verification threshold, mutation order, or capacity was changed. A
canonical production LIVE is still required.
...
Cleanup verified zero semantic devices and links twice and restored Realtime.
Floor2 remained not reached, so its delta-only/PVST causal question is
unchanged.

## Capacity 51 is invalid; restore governed call-control capacities

The governed run
`canonical-cp-scale-voice-20260901T040356110829Z-0b0f2def9748` used pushed
source `0b0f2def9748aef487dd8091d3912ef2f328b397` and rendered Router4
`max-ephones 51 / max-dn 51`. Every one of the 21 Floor1 binding readbacks was
absent; the final authoritative table was empty. Capacity 51 is invalid on this
Packet Tracer 2811 path.

The logical design authority already specifies Router4=42, Router0=12, and
Router3=7, and explicitly records the 51-physical-phone versus 42-ephone gap.
Inferring capacity from the current stage phone count was therefore a source
defect, and projecting 51 replaced it with a design contradiction.

Commit `e83ae0c431c18b5c6e24bcd424a08c5b45d0270d` adds generic declared
call-control capacity to `VoiceIntent`, compiles that value when present, and
sets the canonical documented capacities. Existing intents without a
declaration retain count-derived behavior. The next LIVE tests Router4 at its
governed 42 capacity; it does not claim the later 51>42 acceptance gap is
resolved.
...
## Deferred frontier reconciliation refuted; project final site capacity

The governed run
`canonical-cp-scale-voice-20260901T034510704353Z-ab0a890a6229` used pushed
source `ab0a890a6229d0ae14f19ceb02b0c96be3e3817b`. All 21 initial sibling
bindings were dispatched. Ephones 1-18,20,21 verified; ephone 19 was absent.
Its one deferred post-frontier reconciliation was accepted, but the final fresh
complete table still contained exactly those 20 rows.

This refutes both immediate and deferred reconciliation timing. The retained
terminal state is exactly 20 of 21 explicit ephones.

SOURCE FACT: Floor1 sizes Router4 to the 21 phones currently projected, then
Floor2 would resize it to 35 and Floor3 to 51. The authoritative design,
however, assigns 51 phones to Router4. Call-control capacity is a service
foundation, not a physical object that should grow by replay across stages.

Commit `942f35716d04d89e7f59fbb57bf654dd04bc5e58` projects each active call
control's final designed site capacity from its first stage: Router4 51,
Router0 11, Router3 7. The stage still contains only deployed phone bindings
and keeps stage-local topology/configuration hashes; only service capacity
stops being cumulatively resized.
...
## Immediate reconciliation refuted; defer until sibling frontier closes

The governed run
`canonical-cp-scale-voice-20260901T032640436029Z-3e5b385cb8f2` used pushed
source `3e5b385cb8f287896128f68719df34d18211c388`. Ephones 1-18 verified,
ephone 19 was authoritatively absent, and its single immediate reconciliation
was accepted. The second fresh complete readback still contained only
ephones 1-18. No second reconciliation occurred.

Immediate reconciliation is therefore refuted. Earlier ungated runs established
that independent bindings after the missing ordinal can apply, so stopping
sibling actions at the first absence prevented the next discriminating state.

Commit `e0e4f8848404ea7d48feedb5d52fb0d0c1cfdf8c` now completes the initial
independent binding frontier while retaining every absence and keeping Voice
signal closed. Only after all sibling mutations/readbacks does it reconcile
each proven-absent row once and require exact readback. Mismatches and
unobservable reads still stop immediately; downstream phone-file generation
cannot proceed unless every binding verifies.
...
## Managed CME mode refutes auto-registration

The governed run
`canonical-cp-scale-voice-20260901T031054739651Z-ba2b036561c7` used pushed
source `ba2b036561c72f38ef394408038e1d7a5ccf56b4` and verified the rendered
`no auto-reg-ephone` mode. Ephones 1-18 again verified; ephone 19, still the
nineteenth binding, was again absent from a complete five-page readback.

Auto-registration is therefore refuted as the cause. The stable fact is now:
Packet Tracer accepts the nineteenth typed binding payload but exposes no row
for it, while subsequent bindings can succeed when the workflow does not stop.

An authoritative complete absence proves the first mutation produced no
observable ephone entry, so it safely authorizes one targeted reconciliation of
that same `SET_VALUE` action. Commit
`a9115cdd65fe467bf54968b1d86c5e6dbcec1aca` performs exactly one such
re-dispatch, requires fresh exact readback afterward, refuses to overwrite a
mismatched row, and stops permanently if the row remains absent. This is
state-driven reconciliation, not blind retry.
...
## Semantic order proves the failure follows ordinal 19

The governed run
`canonical-cp-scale-voice-20260901T025406307135Z-ea9b93f0da73` used pushed
source `ea9b93f0da73a7c777edf5fc539d2c8d455af60c` and ordered bindings by
directory index. Ephone 1 verified immediately as the first binding. Ephones
2 through 18 then verified, and ephone 19—the nineteenth dispatched
binding—was absent from a fresh complete five-page table. Ephones 20 and 21
remained unsent.

This refutes both index-1 behavior and opaque hash ordering. Combined with the
prior run, the failure follows ordinal 19.

The plan explicitly provisions every phone by measured MAC, type, button, and
directory index, but the call-control renderer also enabled
`auto-reg-ephone`, a mode Cisco documents for phones whose MACs are not
explicitly configured. The setting is unnecessary for this managed plan and
allows unknown phones to consume CME registration state while explicit
bindings are still being installed.

Commit `6fd0a0a69fdd5f9a5054f073ed6534e4a4fc7ee8` renders
`no auto-reg-ephone` for the typed managed call-control action. All explicit
bindings and mandatory SCCP verification remain unchanged; no phone, index, or
CP-SCALE special case is introduced.
