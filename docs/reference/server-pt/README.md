...
| `evidence/campaign-dhcp-fastloop-01/` | LIVE episode 1 of campaign `SERVER-PT-DHCP-FASTLOOP-01`: lead files, campaign store and the `Q3-FL-C1` record, byte for byte with `MANIFEST.sha256`, 2026-09-25 | nothing: LIVE evidence is immutable; the DHCP fast-loop brief states what it permits |
